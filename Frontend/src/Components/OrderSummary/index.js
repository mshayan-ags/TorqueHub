...
import DiscountCoupon from "../Coupons";
import { MdCheckCircle, MdInventory, MdArrowBack, MdEmail, MdPhone, MdLocationOn } from "react-icons/md";
...
// Pure display, no data-fetching — shared by the authenticated live-socket
// OrderTracking page and the public guest Track-Order page, so both render
// an order identically regardless of how they fetched it.
function OrderSummary({ state, Live }) {
	const navigate = useNavigate();
	const Checked = statusToStep[state?.status] || 0;
		...
		<>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
				...
				<div className="space-y-6">
					<div className="bg-white rounded-2xl border border-[#d2d2d7] overflow-hidden sticky top-24">
						<div className="p-6">
							...
							<div className="relative">
								...
								<div className="relative grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-0">
									<div className="flex flex-col items-center">
										<div className={`relative z-10 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-500 ${Checked >= 1 ? 'bg-[#1d1d1f]' : 'bg-gray-200'
											}`}>
									...
									<div className="flex flex-col items-center">
										<div className={`relative z-10 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-500 ${Checked >= 2 ? 'bg-[#1d1d1f]' : 'bg-gray-200'
											}`}>
									...
									<div className="flex flex-col items-center">
										<div className={`relative z-10 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-500 ${Checked >= 3 ? 'bg-[#1d1d1f]' : 'bg-gray-200'
											}`}>
									...
									<div className="flex flex-col items-center">
										<div className={`relative z-10 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-500 ${Checked >= 4 ? 'bg-[#1d1d1f]' : 'bg-gray-200'
											}`}>
